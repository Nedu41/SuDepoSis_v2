...
# uretir. Amac: build_date alani __DATE__/__TIME__ ile main.cpp'ye baglanirsa
# SADECE main.cpp yeniden derlendiginde guncelleniyordu - baska bir dosyaya
# (orn. bahce_kapisi.cpp) yapilan degisiklikte eski tarih goruntuleniyor, bu
# da "flas gercekten uygulandi mi" sorusunu yanlis cevaplatiyordu (2026-09-17
# kullanici sikayeti, bkz esp8266_slave'deki ayni cozum). Bu script HER
# derlemede calisir, dosya icerigi her seferinde degisir - main.cpp bu
# header'i include ettigi icin PlatformIO onu da her seferinde yeniden derler.
import os
